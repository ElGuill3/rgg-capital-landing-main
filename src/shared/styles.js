...
export function createStyles(t) {
  ...
  const S = {
    ...
    container: { maxWidth: 1180, width: "95%", margin: "0 auto", padding: "0 clamp(16px, 4vw, 24px)" },
    nav: {
      position: "fixed",
      top: 0,
      left: 0,
    ...
    hero: {
      ...
      display: "flex",
      alignItems: "center",
      paddingTop: "clamp(108px, 18vw, 148px)",
    ...
    vertCard: {
      ...
      border: `1px solid ${t.glassBorder}`,
      borderRadius: 16,
      padding: "clamp(16px, 3vw, 20px) clamp(12px, 3vw, 18px)",
      transition: "all 0.35s cubic-bezier(0.4,0,0.2,1)",
      boxShadow: t.glassShadow,
    },
  };
